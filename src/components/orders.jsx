...
const Orders = () => {
  ...
  const deleteProductValueLessThan15k = async () => {
    ...
    const newListAllOrders = allOrders.filter(
      (order) => !listDeletedId.includes(order.id)
    );
  ...
  return (
    <div className="container-fluid">
      ...
      <button
        onClick={() => getAllOrdersInTheLast7Days()}
      ...
      <button
        ...
        onClick={() => deleteProductValueLessThan15k()}
      >
        Delete orders value less than 15k
      </button>
    </div>
  );
};
